    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2020, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Koncert1" },
                    { 2, 0, new DateTime(2021, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Koncert2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 8, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, new DateTime(2021, 8, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
